...
public class StickyFragment extends Fragment implements UpcomingEventListAdapter.Callback {
    ...
    private UpcomingEventListAdapter mUpcomingEventAdapter;

    private ArrayList<DayEventReservations> mDayEventReservationsArrayList;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.activity_sticky_date, container, false);
