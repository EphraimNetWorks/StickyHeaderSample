...
//
//public class DragSelectTouchListener implements SelectableTimelineView.OnItemTouchListener
//{
//
...
//    private SelectableTimelineView mSelectableTimelineView;
...
//                ViewCompat.postOnAnimation(mSelectableTimelineView, mScrollRunnable);
//            }
//        }
//    };
//
...
//
//    @Override
//    public boolean onInterceptTouchEvent(SelectableTimelineView sv, MotionEvent e)
//    {
//        if (!mIsActive)
//            return false;
//
...
//    {
//        if (mSelectableTimelineView == null)
//            return;
//
//        initScroller(mSelectableTimelineView.getContext());
//        if (mScroller.isFinished())
//        {
//            mSelectableTimelineView.removeCallbacks(mScrollRunnable);
...
//
//    @Override
//    public void onTouchEvent(SelectableTimelineView sv, MotionEvent e)
//    {
//        if (!mIsActive)
//            return;
//
...
//    }
//
//    private void updateSelectedRange(SelectableTimelineView sv, MotionEvent e)
//    {
//        updateSelectedRange(sv, e.getX(), e.getY());
//    }
//
//    private void updateSelectedRange(SelectableTimelineView sv, float x, float y)
//    {
//        View child = sv.findViewAt((int)x, (int)y);
//        if (child != null)
//        {
//            int position = sv.getChildAdapterPosition(child);
...
//        if (mDebug)
//            Log.d(TAG, "y = " + y +
//                    " | rv.height = " + mSelectableTimelineView.getHeight() +
...
//        mSelectableTimelineView.scrollBy(0, scrollDistance);
//        if (mLastX != Float.MIN_VALUE && mLastY != Float.MIN_VALUE)
//            updateSelectedRange(mSelectableTimelineView, mLastX, mLastY);
//    }
//
